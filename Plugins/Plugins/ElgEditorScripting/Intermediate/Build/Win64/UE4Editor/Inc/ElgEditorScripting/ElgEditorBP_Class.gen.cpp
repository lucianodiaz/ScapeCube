...
// End Cross Module References
	DEFINE_FUNCTION(UElgEditorBP_Class::execGetClassByName)
	{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UElgEditorBP_Class_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UElgEditorBP_Class_GetClassByName, "GetClassByName" }, // 902547135
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UElgEditorBP_Class, 548054829);
