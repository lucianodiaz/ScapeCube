...
static struct FScriptStruct_ElgEditorScripting_StaticRegisterNativesFS_ElgModuleStatus
{
	...
	{
		UScriptStruct::DeferCppStructOps<FS_ElgModuleStatus>(FName(TEXT("S_ElgModuleStatus")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FS_ElgModuleStatus_Hash() { return 2775929649U; }
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execCanDynamicReloadModule)
	{
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execCanHotReloadModule)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ModuleName);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execIsModuleLoaded)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ModuleName);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execCanRecompileModule)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ModuleName);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execCanShutdownModule)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ModuleName);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execReloadModule)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ModuleName);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execUnloadModule)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ModuleName);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execLoadModule)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ModuleName);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execRecompileModule)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ModuleName);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execGetModuleStatus)
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_ModuleName);
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execGetModulesStatus)
	{
	...
	DEFINE_FUNCTION(UElgEditorBP_FModuleManager::execGetModuleNames)
	{
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UElgEditorBP_FModuleManager_GetModuleNames_Statics::NewProp_Modules = { "Modules", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ElgEditorBP_FModuleManager_eventGetModuleNames_Parms, Modules), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UElgEditorBP_FModuleManager_GetModulesStatus_Statics::NewProp_ModuleNames = { "ModuleNames", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ElgEditorBP_FModuleManager_eventGetModulesStatus_Parms, ModuleNames), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UFunction_UElgEditorBP_FModuleManager_GetModulesStatus_Statics::NewProp_ModulesMap = { "ModulesMap", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ElgEditorBP_FModuleManager_eventGetModulesStatus_Parms, ModulesMap), EMapPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UElgEditorBP_FModuleManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UElgEditorBP_FModuleManager_CanDynamicReloadModule, "CanDynamicReloadModule" }, // 330896598
		{ &Z_Construct_UFunction_UElgEditorBP_FModuleManager_CanHotReloadModule, "CanHotReloadModule" }, // 2387666939
		{ &Z_Construct_UFunction_UElgEditorBP_FModuleManager_CanRecompileModule, "CanRecompileModule" }, // 3194345885
		{ &Z_Construct_UFunction_UElgEditorBP_FModuleManager_CanShutdownModule, "CanShutdownModule" }, // 4229234728
		{ &Z_Construct_UFunction_UElgEditorBP_FModuleManager_GetModuleNames, "GetModuleNames" }, // 289705998
		{ &Z_Construct_UFunction_UElgEditorBP_FModuleManager_GetModulesStatus, "GetModulesStatus" }, // 1329366721
		{ &Z_Construct_UFunction_UElgEditorBP_FModuleManager_GetModuleStatus, "GetModuleStatus" }, // 1094321907
		{ &Z_Construct_UFunction_UElgEditorBP_FModuleManager_IsModuleLoaded, "IsModuleLoaded" }, // 814711942
	...
	IMPLEMENT_CLASS(UElgEditorBP_FModuleManager, 1237839429);
