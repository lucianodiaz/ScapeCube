...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UElgEditorContext_Manager_Statics::NewProp_ConfigContexts = { "ConfigContexts", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UElgEditorContext_Manager, ConfigContexts), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UElgEditorContext_Manager_Statics::NewProp_ConfigContexts_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UElgEditorContext_Manager_Statics::NewProp_ConfigContexts_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UElgEditorContext_Manager, 3231458664);
