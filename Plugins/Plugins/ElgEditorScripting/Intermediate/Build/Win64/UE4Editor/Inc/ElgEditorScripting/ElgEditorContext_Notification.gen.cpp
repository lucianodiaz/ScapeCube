...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_ElgEditorScripting_EBPNotificationCompletionState_Hash() { return 1882901381U; }
...
static struct FScriptStruct_ElgEditorScripting_StaticRegisterNativesFS_ElgNotificationInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FS_ElgNotificationInfo>(FName(TEXT("S_ElgNotificationInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FS_ElgNotificationInfo_Hash() { return 2072058185U; }
...
static struct FScriptStruct_ElgEditorScripting_StaticRegisterNativesFS_ElgNotificationButtons
{
	...
	{
		UScriptStruct::DeferCppStructOps<FS_ElgNotificationButtons>(FName(TEXT("S_ElgNotificationButtons")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FS_ElgNotificationButtons_Hash() { return 2529954317U; }
...
static struct FScriptStruct_ElgEditorScripting_StaticRegisterNativesFS_ElgNotificationButtonInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FS_ElgNotificationButtonInfo>(FName(TEXT("S_ElgNotificationButtonInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FS_ElgNotificationButtonInfo_Hash() { return 4010025962U; }
...
static struct FScriptStruct_ElgEditorScripting_StaticRegisterNativesFS_ElgNotificationIcon
{
	...
	{
		UScriptStruct::DeferCppStructOps<FS_ElgNotificationIcon>(FName(TEXT("S_ElgNotificationIcon")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FS_ElgNotificationIcon_Hash() { return 1011282269U; }
	DEFINE_FUNCTION(UElgEditorContext_Notification::execHandleOnButtonClicked)
	{
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execClear)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Clear();
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execIsNotificationValid)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execSetText)
	{
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execSetCompleteStateSuccess)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execSetCompleteStateFail)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execSetStateAsPending)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execSetCompletionState)
	{
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execFadeout)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Fadeout();
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execExpireAndFadeout)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execCloseAsFail)
	{
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execCloseAsSuccess)
	{
		P_GET_PROPERTY(FTextProperty,Z_Param_Text);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execClose)
	{
		P_GET_PROPERTY(FTextProperty,Z_Param_Text);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UElgEditorContext_Notification::execShow)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Show();
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UElgEditorContext_Notification_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UElgEditorContext_Notification_SetCompletionState, "SetCompletionState" }, // 2358693397
	...
	IMPLEMENT_CLASS(UElgEditorContext_Notification, 275910987);
